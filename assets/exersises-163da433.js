...
`}n.addEventListener("click",async e=>{e.preventDefault();const s=e.target.id,t=JSON.parse(sessionStorage.getItem("data"));if(e.target.tagName=="BUTTON"&&s==s){const i=t.results[s];P(i),J(i)}});function J(e){function s(l){console.log(l.target);const o=JSON.parse(localStorage.getItem("exercises"))||[];console.log(123),o.push(e),localStorage.setItem("exercises",JSON.stringify(o)),[...o];const c=document.querySelector(".pop-add-fav");c&&c.removeEventListener("click",s),document.querySelector(".pop-ex-close-btn"),M.success({title:"Excellent choice!",message:"The exercise has been successfully added to your favorites. Get ready for endless inspiration and great results!",position:"center"})}const t=document.querySelector(".pop-add-fav");t?t.addEventListener("click",s):console.error("Button not found");const i=document.querySelector(".pop-backdrop.is-open");async function r(){await P(e),f.innerHTML="",i.classList.remove("is-open")}i&&i.addEventListener("click",r),window.addEventListener("keydown",function(l){l.key==="Escape"&&(f.innerHTML="")});function a(){f.innerHTML=""}const p=document.querySelector(".pop-ex-close-btn");p?p.addEventListener("click",a):console.error("Close button not found")}const A="./img/icons.svg";document.addEventListener("DOMContentLoaded",async function(){const e=document.createElementNS("http://www.w3.org/2000/svg","svg"),s=document.createElementNS("http://www.w3.org/2000/svg","use");s.setAttributeNS("http://www.w3.org/1999/xlink","href",'./img/icons.svg#icon-trash"'),e.appendChild(s),await x(),document.querySelector(".exercise-trash-button").append(e)});function R(e){I.forEach(s=>{s.classList.remove("exercise-button-active"),e.target.classList.add("exercise-button-active")})}const v=JSON.parse(localStorage.getItem("exercises"));console.log(v);const O=document.querySelector(".fav-list");document.querySelector(".favorites");function x(e){const s=JSON.parse(localStorage.getItem("exercises"));console.log(s),O.innerHTML=s.map(({bodyPart:t,name:i,target:r,burnedCalories:a,_id:p},l)=>`
    <li class="exercise-parts">
      <div class="part-container">
        <div class="exercise-head-container">
          <span class="exercise-badge">WORKOUT</span>
  ...
  `).join(""),F()}x();const D=document.querySelector(".exercise-pages-counter");function F(){document.querySelectorAll(".exercise-trash-button").forEach(s=>{s.addEventListener("click",t=>{const i=t.currentTarget.getAttribute("data-index");v.splice(i,1),localStorage.setItem("exercises",JSON.stringify(v)),x(),v.length<8&&D.classList.add("visually-hidden")})})}x();const W=document.querySelector(".favorite-button");O.addEventListener("click",async e=>{if(e.target===W){e.preventDefault();const s=e.target.id;for(const t of v)t._id===s&&(console.log(t),K(t))}});const $=document.querySelector(".favorite-modal");function K(e){$.innerHTML=`
    <div class="pop-backdrop is-open">
    <div class="pop-ex-modal">
...
//# sourceMappingURL=exersises-163da433.js.map
