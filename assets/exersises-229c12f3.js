...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
  ...
  `).join("")),O()}w();function O(){document.querySelectorAll(".exercise-trash-button").forEach(c=>{c.addEventListener("click",s=>{const t=s.currentTarget.getAttribute("data-index");n.splice(t,1),localStorage.setItem("exercises",JSON.stringify(n)),w(),n.length<8&&L.classList.add("visually-hidden"),n.length===0&&B.classList.remove("visually-hidden")})})}w();const D=document.querySelectorAll(".favorite-button");D.forEach(e=>{e.addEventListener("click",c=>{const s=c.currentTarget.id,t=n.find(i=>i._id===s);t&&F(t)})});n.length>8&&W();function W(){L.innerHTML=`
        <li class="exercise-page-number">
        ...
        </li>`}L.addEventListener("click",async e=>{const c=e.target.id;M.innerHTML=n.slice(c,c+8).map(({bodyPart:s,name:t,target:i,burnedCalories:a,_id:p},d)=>`
    <li class="exercise-parts">
      <div class="part-container">
        <div class="exercise-head-container">
          <span class="exercise-badge">WORKOUT</span>
