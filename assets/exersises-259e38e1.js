import{i as z}from"./vendor-db25513e.js";import{musclesGroup as C,bodyPart as O}from"./api-8d58433a.js";const N=document.querySelector(".exercise-cards-list"),$=document.querySelector(".exercise-cards-list"),v=document.querySelector(".exercise-pages-counter"),j=document.querySelector(".exercise-form"),S=document.querySelector(".exercise-input-button"),x=document.querySelector(".exercise-input"),E=document.querySelectorAll(".exercise-button"),l=document.querySelector(".exercise-parts-list"),h=document.querySelector(".exercise-log-span"),p=document.querySelector(".exercise-title-span");document.querySelector(".exercise-part-button");document.querySelector(".pop-add-fav");document.querySelector(".pop-ex-close-btn");document.querySelector(".pop-backdrop");document.querySelector(".backdrop");document.querySelector(".pop-rating-btn");document.querySelector(".pop-up-close-btn");document.querySelector(".pop-ex-info");document.querySelector(".modal123");document.querySelector(".pop-backdrop.is-open");let f,M="",m=[],y,B=0,L=0,T=0,q=0;localStorage.removeItem("searchInput");localStorage.removeItem("searchQuery");sessionStorage.removeItem("data");N.addEventListener("click",async e=>{e.preventDefault(),m=[],f=1;try{const c=(await C(e)).results;m=[...c],p.innerHTML="",p.textContent=`${c[0].target}`.charAt(0).toUpperCase()+`${c[0].target}`.slice(1),sessionStorage.setItem("data",JSON.stringify({results:c})),B=0;for(let s=0;s<8;s++)B++;if(c.length===0)throw new Error({title:"No Results",message:"No images found. Please try a different search term."});p.style.visibility="visible",$.style.display="none",l.style.display="flex",h.style.visibility="visible",l.innerHTML=c.reduce((s,i,a)=>s+`
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}catch(t){console.error("Error:",t)}});v.addEventListener("click",async e=>{f=e.target.textContent,console.log(f),y=8;try{const s=JSON.parse(localStorage.getItem("searchQuery")).searchQuery;console.log(s);const i=`https://energyflow.b.goit.study/api/exercises?muscles=${s}&page=${f}&limit=${y}`,a=await fetch(i);if(a.status!==200)throw new Error("Failed to fetch data. Please try again later.");const o=(await a.json()).results;sessionStorage.setItem("data",JSON.stringify({results:o})),L=0;for(let r=0;r<8;r++)L++;l.innerHTML=o.reduce((r,u,H)=>r+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}catch(c){console.error("Error:",c)}});E.forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const c=t.target.textContent;localStorage.removeItem("searchInput"),localStorage.removeItem("searchQuery"),A(t),c==="Muscles"?(x.style.display="none",S.style.display="none",l.style.display="none",$.style.display="flex",h.style.visibility="hidden",p.style.visibility="hidden"):c==="Body parts"?(h.style.visibility="hidden",l.innerHTML="",x.style.display="flex",S.style.display="flex",l.style.display="flex",$.style.display="none",v.style.display="none",p.style.visibility="hidden"):(x.style.display="none",S.style.display="none",l.style.display="none",h.style.visibility="hidden",p.style.visibility="hidden")})});j.addEventListener("submit",async function(e){e.preventDefault(),m=[],f=1;try{const t=x.value,s=(await O(t)).results;if(m=[...s],sessionStorage.setItem("data",JSON.stringify({results:s})),s.length===0){l.innerHTML="",console.log(s.length),l.insertAdjacentHTML("beforeend","<li class='no-result-list'><p class='no-result'>Unfortunately,<span class='no-result-span'> no results</span> were found.You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p>"),v.style.display="none";return}else{p.innerHTML="",p.textContent=`${s[0].bodyPart}`.charAt(0).toUpperCase()+`${s[0].bodyPart}`.slice(1),p.style.visibility="visible",h.style.visibility="visible",v.style.display="flex",T=0;for(let i=0;i<8;i++)T++;l.innerHTML=s.reduce((i,a,g)=>i+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}}catch(t){console.error("Error:",t)}});v.addEventListener("click",async e=>{f=e.target.textContent,y=8;try{M=JSON.parse(localStorage.getItem("searchInput")).searchInput;const s=`https://energyflow.b.goit.study/api/exercises?bodypart=${M}&page=${f}&limit=${y}`,i=await fetch(s);if(i.status!==200)throw new Error("Failed to fetch data. Please try again later.");const d=(await i.json()).results;console.log(d.length),sessionStorage.setItem("data",JSON.stringify({results:d})),q=0;for(let o=0;o<8;o++)q++;l.innerHTML=d.reduce((o,r,u)=>o+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
//# sourceMappingURL=exersises-259e38e1.js.map
