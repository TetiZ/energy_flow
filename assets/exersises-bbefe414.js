...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}catch(c){console.error("Error:",c)}});h.addEventListener("click",async e=>{g=e.target.textContent,w=8;try{const i=`https://energyflow.b.goit.study/api/exercises?muscles=${JSON.parse(localStorage.getItem("searchQuery")).searchQuery}&page=${g}&limit=${w}`,a=await fetch(i);if(a.status!==200)throw new Error("Failed to fetch data. Please try again later.");const o=(await a.json()).results;sessionStorage.setItem("data",JSON.stringify({results:o})),E=0;for(let r=0;r<8;r++)E++;l.innerHTML=o.reduce((r,f,C)=>r+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}catch(s){console.error("Error:",s)}});H.forEach(e=>{e.addEventListener("click",c=>{c.preventDefault();const s=c.target.textContent;localStorage.removeItem("searchInput"),localStorage.removeItem("searchQuery"),V(c),s==="Muscles"?(b.style.display="none",k.style.display="none",l.style.display="none",M.style.display="flex",v.style.visibility="hidden",u.style.visibility="hidden",h.style.display="flex"):s==="Body parts"?(v.style.visibility="hidden",l.innerHTML="",b.style.display="flex",k.style.display="flex",l.style.display="flex",M.style.display="none",h.style.display="none",u.style.visibility="hidden"):(b.style.display="none",k.style.display="none",l.style.display="none",v.style.visibility="hidden",u.style.visibility="hidden")})});J.addEventListener("submit",async function(e){e.preventDefault(),m=[],g=1;try{const c=b.value,t=(await U(c)).results;if(m=[...t],sessionStorage.setItem("data",JSON.stringify({results:t})),t.length===0){l.innerHTML="",l.insertAdjacentHTML("beforeend","<li class='no-result-list'><p class='no-result'>Unfortunately,<span class='no-result-span'> no results</span> were found.You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p>"),h.style.display="none";return}else{u.innerHTML="",u.textContent=`${t[0].bodyPart}`.charAt(0).toUpperCase()+`${t[0].bodyPart}`.slice(1),u.style.visibility="visible",v.style.visibility="visible",h.style.display="flex",I=0;for(let i=0;i<8;i++)I++;l.innerHTML=t.reduce((i,a,p)=>i+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
  ...
  `).join("")),O()}S();function O(){document.querySelectorAll(".exercise-trash-button").forEach(c=>{c.addEventListener("click",s=>{const t=s.currentTarget.getAttribute("data-index");n.splice(t,1),localStorage.setItem("exercises",JSON.stringify(n)),S(),n.length<8&&x.classList.add("visually-hidden"),n.length===0&&B.classList.remove("visually-hidden")})})}S();const D=document.querySelectorAll(".favorite-button");D.forEach(e=>{e.addEventListener("click",c=>{const s=c.currentTarget.id,t=n.find(i=>i._id===s);t&&F(t)})});n.length>8&&W();function W(){x&&(x.innerHTML=`
        ...
        </li>`)}x?x.addEventListener("click",async e=>{const c=e.target.id;L.innerHTML=n.slice(c,c+8).map(({bodyPart:s,name:t,target:i,burnedCalories:a,_id:p},d)=>`
    <li class="exercise-parts">
      <div class="part-container">
        <div class="exercise-head-container">
          <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
  ...
  `).join(""),O()}):console.error("pagesCounter не знайдено.");const $=document.querySelector(".favorite-modal");function F(e){$.innerHTML=`
    <div class="pop-backdrop is-open">
    <div class="pop-ex-modal">
...
//# sourceMappingURL=exersises-bbefe414.js.map
