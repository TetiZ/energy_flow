import{i as C}from"./vendor-db25513e.js";import{musclesGroup as j,bodyPart as N}from"./api-8d58433a.js";const U=document.querySelector(".exercise-cards-list"),M=document.querySelector(".exercise-cards-list"),x=document.querySelector(".exercise-pages-counter"),A=document.querySelector(".exercise-form"),k=document.querySelector(".exercise-input-button"),b=document.querySelector(".exercise-input"),I=document.querySelectorAll(".exercise-button"),o=document.querySelector(".exercise-parts-list"),h=document.querySelector(".exercise-log-span"),u=document.querySelector(".exercise-title-span");document.querySelector(".exercise-part-button");document.querySelector(".pop-add-fav");document.querySelector(".pop-ex-close-btn");document.querySelector(".pop-backdrop");document.querySelector(".backdrop");document.querySelector(".pop-rating-btn");document.querySelector(".pop-up-close-btn");document.querySelector(".pop-ex-info");document.querySelector(".modal123");document.querySelector(".pop-backdrop.is-open");let f,B="",y=[],w,L=0,T=0,q=0,E=0;localStorage.removeItem("searchInput");localStorage.removeItem("searchQuery");sessionStorage.removeItem("data");U.addEventListener("click",async e=>{e.preventDefault(),y=[],f=1;try{const s=(await j(e)).results;y=[...s],u.innerHTML="",u.textContent=`${s[0].target}`.charAt(0).toUpperCase()+`${s[0].target}`.slice(1),sessionStorage.setItem("data",JSON.stringify({results:s})),L=0;for(let t=0;t<8;t++)L++;if(s.length===0)throw new Error({title:"No Results",message:"No images found. Please try a different search term."});u.style.visibility="visible",M.style.display="none",o.style.display="flex",h.style.visibility="visible",o.innerHTML=s.reduce((t,i,a)=>t+`
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
        ...
        `,"")}catch(s){console.error("Error:",s)}});I.forEach(e=>{e.addEventListener("click",c=>{c.preventDefault();const s=c.target.textContent;localStorage.removeItem("searchInput"),localStorage.removeItem("searchQuery"),R(c),s==="Muscles"?(b.style.display="none",k.style.display="none",o.style.display="none",M.style.display="flex",h.style.visibility="hidden",u.style.visibility="hidden"):s==="Body parts"?(h.style.visibility="hidden",o.innerHTML="",b.style.display="flex",k.style.display="flex",o.style.display="flex",M.style.display="none",x.style.display="none",u.style.visibility="hidden"):(b.style.display="none",k.style.display="none",o.style.display="none",h.style.visibility="hidden",u.style.visibility="hidden")})});A.addEventListener("submit",async function(e){e.preventDefault(),y=[],f=1;try{const c=b.value,t=(await N(c)).results;if(y=[...t],sessionStorage.setItem("data",JSON.stringify({results:t})),t.length===0){o.innerHTML="",console.log(t.length),o.insertAdjacentHTML("beforeend","<li class='no-result-list'><p class='no-result'>Unfortunately,<span class='no-result-span'> no results</span> were found.You may want to consider other search options to find the exercise you are looking for. Our range is wide and you have the opportunity to find more options that suit your needs.</p>"),x.style.display="none";return}else{u.innerHTML="",u.textContent=`${t[0].bodyPart}`.charAt(0).toUpperCase()+`${t[0].bodyPart}`.slice(1),u.style.visibility="visible",h.style.visibility="visible",x.style.display="flex",q=0;for(let i=0;i<8;i++)q++;o.innerHTML=t.reduce((i,a,d)=>i+`
        <li class="exercise-parts">
            <div class="part-container">
                <div class="exercise-head-container">
                    <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
  ...
  `).join(""),H())}v();n.length>8&&F();const V=document.querySelector(".exercise-pages-counter");function H(){document.querySelectorAll(".exercise-trash-button").forEach(c=>{c.addEventListener("click",s=>{const t=s.currentTarget.getAttribute("data-index");n.splice(t,1),localStorage.setItem("exercises",JSON.stringify(n)),v(),n.length<8&&V.classList.add("visually-hidden")})})}v();const D=document.querySelector(".favorite-button");S.addEventListener("click",async e=>{if(e.target===D){e.preventDefault();const c=e.target.id;for(const s of n)s._id===c&&(console.log(s),K(s))}});function W(){S.innerHTML=`
...
`,document.querySelector(".fav-remove-btn").addEventListener("click",function(t){console.log("clicked");const i=t.currentTarget.getAttribute("data-index");n.splice(i,1),localStorage.setItem("exercises",JSON.stringify(n)),v(),$.innerHTML=""}),document.querySelector(".fav-close-btn").addEventListener("click",function(){$.innerHTML=""})}z.addEventListener("click",function(e){if(e.target.classList.contains("exercise-number-button")){const c=parseInt(e.target.id),s=(c-1)*8,t=c*8;S.innerHTML=n.slice(s,t).map(({bodyPart:i,name:a,target:d,burnedCalories:p},l)=>`
    <li class="exercise-parts">
      <div class="part-container">
        <div class="exercise-head-container">
          <span class="exercise-badge">WORKOUT</span>
...
<path fill="#f6f6f6" style="fill: var(--color1, #f6f6f6)" d="M20.919 10.126c1.166 0 2.111-0.924 2.111-2.063s-0.945-2.063-2.111-2.063c-1.166 0-2.111 0.924-2.111 2.063s0.945 2.063 2.111 2.063z"></path>
  ...
  `).join(""),H()}});v();
//# sourceMappingURL=exersises-cce8d4be.js.map
